...
1.Оформление блоков текста.
 * Блоки текста с ответами на вопросы не отделены друг от друга графически. В идеале можно было добавить разделители в виде горизонтальной черты между блоками, таким же способом, как на этой странице отделены друг от друга задачи.
 * В тексте не выделены важные данные - такие, как даты, числа, цены, величины, web-адреса, отметки о важном и т.п. Стоит выделить их **жирным** шрифтом или каким то еще `способом`. Упоминания различных брендов X5, таких, как Пятерочка и Перекресток лучше выделить в тексте цветами этих брендов или вообще заменить читаемыми логотипами прямо в строках, так чтобы это было минималистично и, при этом - информативно.
...
2. Объем текста
 * Тексты стоит сократить до 300-500 знаков   
3. Структура текста.
...
4. Тезисы об отсутствии чего-то прямо сейчас. Пример - пункт "Как узнать в каком из магазинов есть кофе-стенд?".
 * Сейчас в этом пункте текст ответа на вопрос начинается с отрицательного утверждения *"У нас пока нет карты со всеми точками приготовления горячих напитков, но мы работаем над этим. Сейчас вы можете узнать о наличии кофе-стенда у сотрудников непосредственно в магазине."*. Возможно, стоит переформулировать этот и подобные тексты так, что там не будет отрицания в явном виде
5.
6.
7.
8.
