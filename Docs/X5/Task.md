...
3. Проверка собранного по списку:
 3.1 Убедитесь, что все вещи чистые и целые (если нет других указаний).
 3.2 Грязные вещи нужно постирать.
 3.3 Поврежденные вещи замените или отремонтируйте, если возможно.      
